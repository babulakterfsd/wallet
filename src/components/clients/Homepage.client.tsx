...
const HomepageClient = () => {
  return (
    <div>
      <div className="mt-6 lg:mt-16 flex flex-col lg:flex-row items-center justify-center min-h-screen py-16">
        {/* Content Section */}
        <div className="flex-1 text-center lg:text-left lg:pr-12 mb-12 lg:mb-0">
          ...
          >
            ...
            our secure and intuitive digital wallet. Send, receive, and track
            your transactions with complete peace of mind.
          </p>
